...
public interface IAgencyStaffRepository
{
    ...
    Task<AgencyStaff?> GetByAgencyAndUserIdAsync(Guid agencyId, string userId, CancellationToken cancellationToken = default);
    ...
    Task<bool> UserHasRoleInAgencyAsync(string userId, Guid agencyId, string role, CancellationToken cancellationToken = default);
}
